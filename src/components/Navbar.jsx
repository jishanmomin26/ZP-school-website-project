...
const Navbar = () => {
  ...
  const TEACH_FOR_INDIA_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSed50LsJmgSCMb1bK5hoDcIWkad6VShYK1dQc0QP0lPBdQ6WA/viewform';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <a
                href={TEACH_FOR_INDIA_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 rounded-lg text-sm font-semibold bg-orange-500 text-white hover:bg-orange-600 transition-all duration-200 shadow-sm hover:shadow-md"
              >
                🎓 Teach for India
              </a>
            </div>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-dark-100">
                <div className="flex items-center gap-2">
                  <img src="/edusync-logo.jpg" alt="School Logo" className="w-8 h-8 rounded-full object-cover" />
              ...
              <div className="p-4 space-y-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block px-4 py-3 rounded-lg text-sm font-semibold text-center text-white bg-orange-500 hover:bg-orange-600 transition-colors duration-200"
                >
                  🎓 Teach for India
                </a>
